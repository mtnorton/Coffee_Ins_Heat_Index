# calc_distances.R
# Used in previous iteration of research
# Calculates nearest weather station for each plot using get.knnx()
# As of 8/25 needs to be updated for heat index data
